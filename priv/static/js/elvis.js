...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Elvis = __webpack_require__(3);

	var _Elvis2 = _interopRequireDefault(_Elvis);
	...
	var elmApp = _Elvis2.default.embed(_Elvis2.default.Elvis, elmDiv);
...
/***/ function(module, exports) {
	...
	Elm.Elvis = Elm.Elvis || {};
	Elm.Elvis.make = function (_elm) {
	   "use strict";
	   _elm.Elvis = _elm.Elvis || {};
	   if (_elm.Elvis.values) return _elm.Elvis.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   ...
	   return _elm.Elvis.values = {_op: _op,main: main};
	};
