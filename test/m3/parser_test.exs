defmodule M3.ParserTest do
  ...
  test "it extracts the media urls", context do
    ...
    assert playlist.media == [
      %M3.Variant{url: "http://hlsstream.io/something/stream/high/segment.m3u8", bandwidth: 339200, codecs: [["mp4a", "40.2"]], program_id: "1"},
      %M3.Variant{url: "http://hlsstream.io/something/stream/med/segment.m3u8", bandwidth: 135680, codecs: [["mp4a", "40.2"]], program_id: "1"},
      %M3.Variant{url: "http://hlsstream.io/something/stream/low/segment.m3u8", bandwidth: 101760, codecs: [["mp4a", "40.2"]], program_id: "1"},
    ]
  end
