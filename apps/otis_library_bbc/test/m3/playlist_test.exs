  ...
  test "can provide the next set of media based on media sequence numbers", context do
    ...
    assert media == [
             %M3.Media{
               duration: 6,
               filename: "no desc",
               url: "http://hlsstream.io/something/stream/226201869.ts"
             }
           ]
    ...
    assert media == [
             %M3.Media{
               duration: 6,
               filename: "no desc",
               url: "http://hlsstream.io/something/stream/226201870.ts"
             }
           ]
    ...
    assert media == [
             %M3.Media{
               duration: 6,
               filename: "no desc",
               url: "http://hlsstream.io/something/stream/226201871.ts"
             },
             %M3.Media{
               duration: 6,
               filename: "no desc",
               url: "http://hlsstream.io/something/stream/226201872.ts"
             }
           ]
  end
