defmodule Peel.Test.LibraryTest do
  ...
  setup do
    ...
    collection =
      %Collection{name: "My Music", id: Ecto.UUID.generate(), path: root} |> Repo.insert!()

    other_collection =
      %Collection{name: "Other Music", id: Ecto.UUID.generate(), path: root} |> Repo.insert!()

    artists = [
      %Artist{
        collection_id: collection.id,
        id: "fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e",
        name: "Talking Heads",
        normalized_name: "talking heads"
      },
      %Artist{
        collection_id: collection.id,
        id: "ece2ce41-3194-4506-9e16-42e56e1be090",
        name: "Echo and the Bunnymen",
        normalized_name: "echo and the bunnymen"
      },
      %Artist{
        collection_id: collection.id,
        id: "b408ec33-f533-49f6-944b-5d829139e1de",
        name: "The Lurkers",
    ...
    albums = [
      %Album{
        id: "7aed1ef3-de88-4ea8-9af7-29a1327a5898",
        collection_id: collection.id,
        date: "1977",
        disk_number: 1,
        disk_total: 1,
        genre: "Rock",
        normalized_title: "talking heads 77",
        performer: "Talking Heads",
        cover_image:
          "/fs/d2e91614-135a-11e6-9170-002500f418fc/cover/7/a/7aed1ef3-de88-4ea8-9af7-29a1327a5898.jpg",
        title: "Talking Heads: 77",
        track_total: 2
      },
      %Album{
        id: "1f74a72a-800d-443e-9bb2-4fc5e10ff43d",
        collection_id: collection.id,
        date: nil,
        disk_number: 1,
        disk_total: 1,
        genre: "Rock",
        normalized_title: "some compilation",
        performer: "Various Artists",
        cover_image:
          "/fs/d2e91614-135a-11e6-9170-002500f418fc/cover/1/f/1f74a72a-800d-443e-9bb2-4fc5e10ff43d.jpg",
    ...
    tracks = [
      %Peel.Track{
        id: "94499562-d2c5-41f8-b07c-ecfbecf0c428",
        collection_id: collection.id,
        album_id: "7aed1ef3-de88-4ea8-9af7-29a1327a5898",
        album_title: "Talking Heads: 77",
        artist_id: "fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e",
        ...
        path:
          "iTunes/iTunes Media/Music/Talking Heads/Talking Heads_ 77/01 Uh-Oh, Love Comes To Town.m4a",
        performer: "Talking Heads",
      ...
      %Peel.Track{
        id: "a3c90ce4-8a98-405f-bffd-04bc744c13df",
        collection_id: collection.id,
        album_id: "7aed1ef3-de88-4ea8-9af7-29a1327a5898",
        album_title: "Talking Heads: 77",
        artist_id: "fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e",
      ...
      %Peel.Track{
        id: "63f49bae-fcbf-49df-94c9-668c52f3e125",
        collection_id: collection.id,
        album_id: "1f74a72a-800d-443e-9bb2-4fc5e10ff43d",
        album_title: "Some Compilation",
        artist_id: "ece2ce41-3194-4506-9e16-42e56e1be090",
      ...
      %Peel.Track{
        id: "59afcd1e-9f6f-4df5-9ece-5f874d6e36bd",
        collection_id: collection.id,
        album_id: "1f74a72a-800d-443e-9bb2-4fc5e10ff43d",
        album_title: "Some Compilation",
        artist_id: "b408ec33-f533-49f6-944b-5d829139e1de",
        ...
        performer: "The Lurkers",
        title: "Ain't Got a Clue",
        track_number: 2,
        track_total: 3
      },
      %Peel.Track{
        id: "0a89f07e-0f5e-48c4-8b00-d83026a90724",
        collection_id: collection.id,
        album_id: "1f74a72a-800d-443e-9bb2-4fc5e10ff43d",
        album_title: "Some Compilation",
        artist_id: "fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e",
        ...
        normalized_title: "uh oh love comes to town",
        path:
          "iTunes/iTunes Media/Music/Various Artists/Some Compilation/Uh-Oh, Love Comes To Town.m4a",
        performer: "Talking Heads",
        title: "Uh-Oh, Love Comes To Town",
        track_number: 3,
        track_total: 3
  ...
  test "peel:collection/:collection_id", context do
    ...
    assert response == %{
             ...
             search: %{
               title: context.collection.name,
               url: "peel:search/#{context.collection.id}"
             },
             length: 2,
             children: [
               %{
               ...
               %{
                 ...
                 children: [
                   %{
                     ...
                     actions: %{
                       click: %{
                         url: "peel:album/1f74a72a-800d-443e-9bb2-4fc5e10ff43d",
                         level: true
                       },
                       play: %{
                         url: "peel:album/1f74a72a-800d-443e-9bb2-4fc5e10ff43d/play",
                         level: false
                       }
                     },
                     icon:
               ...
               %{
                 ...
                 children: [
                   %{
                     ...
                     actions: %{
                       click: %{
                         url: "peel:album/7aed1ef3-de88-4ea8-9af7-29a1327a5898",
                         level: true
                       },
                       play: %{
                         url: "peel:album/7aed1ef3-de88-4ea8-9af7-29a1327a5898/play",
                         level: false
                       }
                     },
                     icon:
                     ...
                     metadata: [
                       [
                         %{
                           title: "Talking Heads",
                           action: %{
                             url: "peel:artist/fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e",
                             level: true
                           }
                         }
                       ],
                 ...
                 children: [
                   %{
                     actions: %{
                       click: %{
                         level: true,
                         url: "peel:artist/ece2ce41-3194-4506-9e16-42e56e1be090"
                       },
                       play: nil
                     },
                     icon: "",
                 ...
                 children: [
                   ...
                   %{
                     actions: %{
                       click: %{
                         level: true,
                         url: "peel:artist/b408ec33-f533-49f6-944b-5d829139e1de"
                       },
                       play: nil
                     },
                     icon: "",
             ...
             children: [
               ...
               %{
                 ...
                 actions: %{
                   click: %{
                     url:
                       "peel:album/7aed1ef3-de88-4ea8-9af7-29a1327a5898/artist/fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e/play",
                     level: false
                   },
                   play: %{
                     url:
               ...
               %{
                 ...
                 actions: %{
                   click: %{
                     url:
                       "peel:album/1f74a72a-800d-443e-9bb2-4fc5e10ff43d/artist/fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e/play",
                     level: false
                   },
                   play: %{
                     url:
  ...
  test "search all music", %{channel_id: channel_id} = context do
    artists = [
      %Artist{
        ...
        id: "fdb8a7b3-e259-4ef3-a453-833f2795dec6",
        name: "The Big Monkey",
    ...
    albums = [
      %Album{
        id: "69eff193-5808-4165-a927-b5431d7da97b",
        collection_id: context.collection.id,
        date: "1977",
        disk_number: 1,
        disk_total: 1,
        genre: "Rock",
        normalized_title: "monkey songs",
        performer: "Monkey Sings",
        cover_image: "",
        title: "Monkey Songs",
        track_total: 2
      },
      %Album{
        id: "8231ab23-0c44-44b1-891c-53917f085d82",
        collection_id: context.collection.id,
        date: nil,
        disk_number: 1,
        disk_total: 1,
        genre: "Rock",
        normalized_title: "dance monkey dance",
        performer: "Various Artists",
        cover_image: "",
    ...
    tracks = [
      %Peel.Track{
        id: "118739fb-4558-4522-987d-bd3c5e805d7a",
        collection_id: context.collection.id,
        album_id: "7aed1ef3-de88-4ea8-9af7-29a1327a5898",
        album_title: "Talking Heads: 77",
        artist_id: "fbc1a6eb-57a8-4e85-bda3-e493a21d7f9e",
               ...
               %{
                 ...
                 children: [
                   %{
                     ...
                     actions: %{
                       click: %{
                         url: "peel:album/69eff193-5808-4165-a927-b5431d7da97b",
                         level: true
                       },
                       play: %{
                         url: "peel:album/69eff193-5808-4165-a927-b5431d7da97b/play",
                         level: false
                       }
                     },
                     icon: "",
                     metadata: [
                       [%{action: nil, title: "Various Artists"}],
                       [%{action: nil, title: "1977"}]
                     ]
                   },
                   %{
                     title: "Dance Monkey Dance",
                     actions: %{
                       click: %{
                         url: "peel:album/8231ab23-0c44-44b1-891c-53917f085d82",
                         level: true
                       },
                       play: %{
                         url: "peel:album/8231ab23-0c44-44b1-891c-53917f085d82/play",
                         level: false
                       }
                     },
                     icon: "",
                 ...
                 children: [
                   %{
                     actions: %{
                       click: %{
                         level: true,
                         url: "peel:artist/fdb8a7b3-e259-4ef3-a453-833f2795dec6"
                       },
                       play: nil
                     },
                     icon: "",
