defmodule Test.Otis.Packet do
  ...
  test "packet unmarshalling" do
    ...
    %Packet{packet_number: n, timestamp: timestamp, data: audio, packet_size: packet_size} =
      packet
