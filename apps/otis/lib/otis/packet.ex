defmodule Otis.Packet do
  ...
  Updates a packet's position by one audio frame:
      ...
      %Otis.Packet{ source_id: "1234", position: 20, duration: 100, packet_size: 3528, index: 1 }
      iex> _packet = Otis.Packet.step(packet)
      %Otis.Packet{ source_id: "1234", position: 40, duration: 100, packet_size: 3528, index: 2 }
      ...
      iex> packet = Otis.Packet.step(packet)
      %Otis.Packet{ source_id: "1234", position: 100, duration: 10000, packet_size: 17640, index: 1 }
      iex> _packet = Otis.Packet.step(packet)
      %Otis.Packet{ source_id: "1234", position: 200, duration: 10000, packet_size: 17640, index: 2 }
  ...
  def packet_size_to_step_duration(packet_size) do
    round(1000 * (packet_size / (Otis.stream_bytes_per_second)))
  end
end
